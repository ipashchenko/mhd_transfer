...
# Set True for making spectral index maps with known true model
do_scaling_flux_relative_to_high_freq = False
...
save_dir = "/home/ilya/data/mf/spix/2ridges/VSOP"
# Saving final images
save_dir2 = "/home/ilya/data/mf/spix/2ridges/VSOP"
...
# template_ccimages = {1.6: create_clean_image_from_fits_file("/home/ilya/Downloads/VSOP/template_l_beam.fits"),
#                      4.8: create_clean_image_from_fits_file("/home/ilya/Downloads/VSOP/template_c_beam.fits")}
...
#         if do_scaling_flux_relative_to_high_freq:
#             scale = 0.51*(freq_high/freq)**(-alpha_true)
#         else:
#             scale = 0.51
#         jm.load_image_stokes("I", "{}/{}_jet_image_i_{}.txt".format(jetpol_files_directory, mhdrt_code, 15.4), scale=scale)
...
#                             PA_deg=107.0)
#
#         # FIXME: Comment out if only UVFITS is needed
#         # Convolve with beam
...
fig = iplot(ipol, spix_array, x=ccimages[freq_low].x, y=ccimages[freq_low].y,
            min_abs_level=3*std, colors_mask=common_imask, color_clim=[-1., 1.], blc=blc, trc=trc,
            beam=beam, close=True, colorbar_label=r"$\alpha$", show_beam=True, show=False,
            cmap='bwr', contour_color='black', plot_colorbar=True,
            contour_linewidth=0.25)
