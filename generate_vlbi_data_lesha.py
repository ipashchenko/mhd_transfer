...
template_uvfits_dict = {8.1: "/home/ilya/data/M87Lesha/to_ilya/1228+126.X.2009_05_23.uvf_cal",
                        15.4: "/home/ilya/data/M87Lesha/to_ilya/1228+126.U.2009_05_23C.uvf_cal"}
model_dfm_dict = {8.1: "/home/ilya/data/M87Lesha/to_ilya/1228+126.X.2009_05_23.cc",
                  15.4: "/home/ilya/data/M87Lesha/to_ilya/1228+126.U.2009_05_23C.cc"}
model_dfm_dict_edt = {8.1: "/home/ilya/data/M87Lesha/art/1228+126.X.2009_05_23.edt.cc",
                      15.4: "/home/ilya/data/M87Lesha/art/1228+126.U.2009_05_23C.edt.cc"}
...
for freq in freqs_obs_ghz:
    # Cut emission further 100 mas
    filter_CC_dimap_by_rmax(model_dfm_dict[freq], 30.0, model_dfm_dict_edt[freq])
    # CCFITS_to_difmap(model_ccfits_dict[freq], os.path.join(save_dir, "cc_true_{}.mdl".format(freq)))
    convert_difmap_model_file_to_CCFITS(os.path.join(save_dir, model_dfm_dict_edt[freq]), "I",
...
if not only_make_pics:
    ...
    for freq in freqs_obs_ghz:
        ...
        jm = create_model_from_fits_file(os.path.join(save_dir, "ccmap_true_{}.fits".format(freq)))
...
fig = iplot(ipol, bias_spix_array, x=ccimages[freq_low].x, y=ccimages[freq_low].y,
            min_abs_level=5*std, colors_mask=common_imask, color_clim=[-0.5, 0.5], blc=blc, trc=trc,
            beam=beam, close=True, colorbar_label=r"$\alpha$", show_beam=True, show=False,
