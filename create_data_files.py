...
np.savetxt(os.path.join(files_dir, "{}_Gamma_field.txt".format(run_name)), np.dstack((result_z_pc, result_r_pc, result_Gamma))[0])
np.savetxt(os.path.join(files_dir, "{}_n_plasma_field.txt".format(run_name)), np.dstack((result_z_pc, result_r_pc, result_n_plasma))[0])
np.savetxt(os.path.join(files_dir, "{}_B_p_field.txt".format(run_name)), np.dstack((result_z_pc, result_r_pc, result_Bp))[0])
np.savetxt(os.path.join(files_dir, "{}_B_phi_field.txt".format(run_name)), np.dstack((result_z_pc, result_r_pc, result_Bphi))[0])
np.savetxt(os.path.join(files_dir, "{}_beta_phi_field.txt".format(run_name)), np.dstack((result_z_pc, result_r_pc, result_beta_phi))[0])
np.savetxt(os.path.join(files_dir, "{}_jsq_plasma_field.txt".format(run_name)), np.dstack((result_z_pc, result_r_pc, result_jsq_plasma))[0])