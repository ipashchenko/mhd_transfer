...
def find_scale(mhd_code, executable_sf, required_flux_Jy=1.0, gamma_min=100.0, executable_dir=None, changing_s=False):
    cwd = os.getcwd()
    ...
    def flux_diff(scale):
        os.system("./{} {} {} {} {}".format(executable_sf, mhd_code, scale, gamma_min, changing_s))
        ...
        for gamma_in in (2, 3.4, 5):
            ...
            for rt in ("n", "b", "j"):
                for gamma_min in (1, 100, 200):
                    ...
                    res = find_scale(mhd_code, executable_sf, required_flux_Jy=1.0, gamma_min=gamma_min,
                                     executable_dir=transfer_dir, changing_s=False)
                    scale = res[0][0]
                    os.system("./{} {} {} {} {}".format(executable_mf, mhd_code, scale, gamma_min, "false"))
                    plot_images(mhd_code=mhd_code, rt_code=rt, txt_files_dir=transfer_dir, save_dir=images_save_dir)